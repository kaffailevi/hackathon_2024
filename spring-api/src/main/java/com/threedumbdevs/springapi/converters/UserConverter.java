...
public class UserConverter {
    ...
    public static UserTO convertUserToUserTO(User user) {
        return new UserTO(user.getId(), user.getFirstName(), user.getLastName(), user.getEmail() ,user.getAge(), user.isAvailableForHire(), user.getRating(), user.getProfilePictureUrl());
    }
